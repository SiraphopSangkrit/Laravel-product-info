        ...
        <Modal :show="CreateModal" @close="handleClose" maxWidth="6xl" closeable>
            ...
            <div class="p-4 md:p-5">
                <form class="space-y-4" @submit.prevent="GroupCreate">
                    ...
                    <button type="submit"
                        class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-lg px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">เพิ่มกลุ่มสินค้า</button>
                </form>
            </div>
        </Modal>
