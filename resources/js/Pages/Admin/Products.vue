...
const openImgModal = async (product) => {
...
const fetchProductImages = async (productId) => {
  try {
    const response = await fetch(route('admin.getProductImages', productId));
...
const handleFilePondUpdate = (fileItems) => {
    imageForm.image = fileItems.map((fileItem) => fileItem.file);
};

const AddImage = () => {
    imageForm.post(
        route("admin.addProductPics", { id: imageForm.product_id }),
        {
            onSuccess: () => {
                handleClose();
                imageForm.reset();
...
const ProductUpdate = () => {
    editForm.put(
        route("admin.updateProduct", { id: editForm.product_id_edit }),
        {
            onSuccess: () => {
                handleClose();
...
<template>
    <AdminLayout>
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            ...
            >
                <thead
                    class="text-gray-700 uppercase bg-gray-200 dark:bg-gray-700 dark:text-gray-400"
                >
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3">แบรนด์สินค้า</th>
                        <th scope="col" class="px-6 py-3">ประเภทสินค้า</th>
                        <th scope="col" class="px-6 py-3">กลุ่มสินค้า</th>
                        <th scope="col" class="px-6 py-3">ชนิดสินค้า</th>
                        <th scope="col" class="px-6 py-3">รูป</th>
                        <th scope="col" class="px-6 py-3">ราคาสินค้า</th>
                ...
                <tbody>
                    ...
                    >
                        ...
                        <td
                            class="truncate max-w-xs px-6 py-4"
                        ...
                        <td class="px-6 py-4">
                            ...
                            >
                                <input
                                    type="checkbox"
                                    :checked="product.product_status"
                                    class="sr-only peer"
                        ...
                        >
                            ...
                            <div class="m-2">
                                <button
                                    type="button"
                                    @click="
                                        ProductImgDelete(image.ProductPic_id)
                                    "
                ...
                <div class="mt-3">
                    <form @submit.prevent="AddImage">
                        <div class="max-w-xl mx-auto">
                            ...
                            <InputError
                                class="my-2"
                                :message="imageForm.errors.image"
                            />
                        </div>
                ...
                <form class="space-y-4" @submit.prevent="ProductCreate">
                    <div class="flex flex-row">
                        ...
                        <div class="w-full mx-2">
                            ...
                            <InputError
                                class="mt-2"
                                :message="createForm.errors.product_name"
                            />
                        </div>
                    </div>
                    <div class="flex flex-row">
                        <div class="w-full mx-2">
                            <label
                                class="block mb-2 text-lg font-medium text-gray-900 dark:text-white"
                                >เลือกประเภทสินค้า</label
                            >
                            <select
                                v-model="createForm.producttype_id"
                            ...
                            <InputError
                                class="mt-2"
                                :message="createForm.errors.producttype_id"
                            />
                        </div>
                        ...
                        <div class="w-full mx-2">
                            ...
                            <InputError
                                class="mt-2"
                                :message="createForm.errors.brand_id"
                            />
                        </div>
                        ...
                        <div class="w-full mx-2">
                            ...
                            <InputError
                                class="mt-2"
                                :message="createForm.errors.group_id"
                            />
                        </div>
                        <div class="w-full mx-2">
                            <label
                                class="block mb-2 text-lg font-medium text-gray-900 dark:text-white"
                                >เลือกชนิดสินค้า</label
                            >
                            <select
                                v-model="createForm.kind_id"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            >
                                <option selected disabled>
                                    เลือกชนิดสินค้า
                            ...
                            <InputError
                                class="mt-2"
                                :message="createForm.errors.kind_id"
                            />
                        </div>
                    </div>
                    <div>
                        ...
                        <textarea
                            id="message"
                            rows="4"
                            v-model="createForm.product_desc"
                        ...
                        <InputError
                            class="mt-2"
                            :message="createForm.errors.product_desc"
                        />
                    </div>
                    <div>
                        <label
                            class="block mb-2 text-lg font-medium text-gray-900 dark:text-white"
                            >รายละเอียดสินค้า (เพิ่มเติม)</label
                        >
                        <textarea
                            id="message"
                            rows="4"
                            v-model="createForm.product_desc0"
                            class="block p-2.5 w-full text-lg text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="รายละเอียดสินค้า (เพิ่มเติม)"
                        ></textarea>
                    </div>
                    <div>
                        <label
                        ...
                        <textarea
                            id="message"
                            rows="4"
                            v-model="createForm.product_desc1"
                            class="block p-2.5 w-full text-lg text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="รายละเอียดสินค้า (เพิ่มเติม)"
                        ></textarea>
                    </div>
                    <div>
                        ...
                        <InputError
                            class="mt-2"
                            :message="createForm.errors.product_price"
                        />
                    </div>
                    <button
                        type="submit"
                ...
                <form class="space-y-4" @submit.prevent="ProductUpdate">
                    <div class="flex flex-row">
                        <div>
                            ...
                            <input
                                type="text"
                                v-model="editForm.product_id_edit"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                                placeholder="รหัสสินค้า"
                                required
                                disabled
                        ...
                        <div class="w-full mx-2">
                            ...
                            <input
                                type="text"
                                v-model="editForm.product_name_edit"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                                placeholder="ชื่อสินค้า"
                                required
                            />
                            <InputError
                                class="mt-2"
                                :message="editForm.errors.product_name_edit"
                            />
                        </div>
                    </div>
                    <div class="flex flex-row">
                        <div class="w-full mx-2">
                            ...
                            <select
                                ...
                                v-model="editForm.producttype_id_edit"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            >
                                <option selected disabled>
                                    เลือกประเภทสินค้า
                            ...
                            <InputError
                                class="mt-2"
                                :message="editForm.errors.producttype_id_edit"
                            />
                        </div>
                        ...
                        <div class="w-full mx-2">
                            ...
                            <select
                                id="brand_id"
                                v-model="editForm.brand_id_edit"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            >
                                <option selected disabled>
                                    เลือกแบรนด์สินค้า
                            ...
                            <InputError
                                class="mt-2"
                                :message="editForm.errors.brand_id_edit"
                            />
                        </div>
                        ...
                        <div class="w-full mx-2">
                            ...
                            <select
                                id="group_id"
                                v-model="editForm.group_id_edit"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            >
                                <option selected disabled>
                                    เลือกกลุ่มสินค้า
                            ...
                            <InputError
                                class="mt-2"
                                :message="editForm.errors.group_id_edit"
                            />
                        </div>
                        <div class="w-full mx-2">
                            <label
                            ...
                            <InputError
                                class="mt-2"
                                :message="editForm.errors.kind_id_edit"
                            />
                        </div>
                    </div>
                    <div>
                        ...
                        <textarea
                            id="message"
                            rows="4"
                            v-model="editForm.product_desc_edit"
                            class="block p-2.5 w-full text-lg text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="รายละเอียดสินค้า"
                        ></textarea>
                        <InputError
                            class="mt-2"
                            :message="editForm.errors.product_desc_edit"
                        />
                    </div>
                    <div>
                        <label
                        ...
                        <textarea
                            id="message"
                            rows="4"
                            v-model="editForm.product_desc0_edit"
                            class="block p-2.5 w-full text-lg text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="รายละเอียดสินค้า (เพิ่มเติม)"
                        ></textarea>
                    </div>
                    <div>
                        ...
                        <textarea
                            id="message"
                            rows="4"
                            v-model="editForm.product_desc1_edit"
                            class="block p-2.5 w-full text-lg text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="รายละเอียดสินค้า (เพิ่มเติม)"
                        ></textarea>
                    </div>
                    <div>
                        ...
                        <input
                            type="number"
                            id="product_price"
                            v-model="editForm.product_price_edit"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                        ...
                        <InputError
                            class="mt-2"
                            :message="editForm.errors.product_price_edit"
                        />
                    </div>
