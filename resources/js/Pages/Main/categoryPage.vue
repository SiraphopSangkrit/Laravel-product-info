                                    ...
                                    <TransitionChild as="template" enter="transition ease-in-out duration-300 transform"
                                        ...
                                        <DialogPanel
                                            ...
                                            <div class="flex items-center justify-between px-4">
                                                <h2 class="text-lg font-medium text-gray-900">ประเภทสินค้า</h2>
                                                <button type="button"
                                                        ...
                                                        <div class="space-y-6">
                                                            <div v-for="(option, optionIdx) in section.options"
                                                                ...
                                                                <input :id="`filter-mobile-${section.id}-${optionIdx}`"
                                                                    ...
                                                                    type="checkbox" :checked="option.checked" v
                                ...
                                <div class="flex flex-row">
                                                ...
                                                <div class="space-y-6">
                                                    <div v-for="kindFilter in kinds" :key="kindFilter.kind_id"
                                                        ...
                                                        <input name="brands" :value="kindFilter.kind_id" type="checkbox"
                                                            v-model="activeFilters.kinds" @change="updateFilters"
                                                            class="size-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" />
                                                        <label class="ml-3 min-w-0 flex-1 text-gray-500">{{
                                    ...
                                    <div class="lg:col-span-3 w-full">
                                        <div class="flex justify-end mb-5 mr-5">
                                            <Pagination :elements="products" @pagination-change="updateFilters">
                                            </Pagination>
                                        </div>
                                        <section id="Projects"
