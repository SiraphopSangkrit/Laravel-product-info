...
<template>
    <AppLayout>
        ...
        <div class="flex justify-start">
            <div class="mt-5 lg:ml-24 md:ml-10 sm:ml-2">
                <Category>
        ...
        <div class="flex justify-center">
            ...
            <div class="flex flex-col">
                ...
                <div v-for="(banner, index) in banners" :key="index">
                    <img class="h-auto max-w-full" :src="/storage/ + banner.public_url" :alt="'Banner' + (index + 1)" />
                </div>
                <div class="mx-auto">
                    ...
                    <div class="grid lg:grid-cols-3 gap-4 ml-5 md:grid-cols-2  sm:grid-cols-1">
