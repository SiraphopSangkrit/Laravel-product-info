                                ...
                                <div class="p-4 lg:max-w-5xl max-w-lg mx-auto">
                                    <div class="grid items-start grid-cols-1 lg:grid-cols-2 gap-6 max-lg:gap-12">
                                        ...
                                        <div class="w-full top-0 gap-2 flex">
                                            <div class="flex-col">
                                                <div class=" w-16"
                                                    v-for="Pic in productPic" :key="Pic.ProductPic_id"
                                                    ...
                                                    <img :src="Pic
                                                        ...
                                                        :alt="Pic
                                                            ...
                                                            : 'No Image Available'" class="w-full rounded-lg cursor-pointer hover:opacity-80 transition-opacity mt-2" />
                                                </div>
                                            </div>
